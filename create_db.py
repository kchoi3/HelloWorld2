...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'kchoi3', 'email': 'kchoi3@terpmail.umd.edu', 'first_name': 'Kwang Seo', 'last_name': 'Choi',
         'password': generate_password_hash('kchoi3', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
    ...
    students = [
        ...
        {'first_name': 'Kwang Seo', 'last_name': 'Choi', 'email': 'kchoi3@terpmail.umd.edu',
